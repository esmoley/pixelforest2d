    ...
    return <>
        <div className="flex justify-center pt-2" style={{height:"65px", backgroundColor:"#222222", color:"aliceblue"}}>
            ...
            <div className="flex-initial">
                <button
                    disabled={started}
                    className={"px-4 py-2 border border-red-500 text-red-500 transition-all duration-200"+
                        (started?' translate-y-[4px]':' hover:text-white hover:bg-red-500 border-b-4')}
                    onClick={()=>{
                ...
                <button
                    disabled={!started}
                    className={"px-4 py-2 border border-slate-500 text-slate-500 transition-all duration-200"+
                        (!started?' translate-y-[4px]':' hover:text-white hover:bg-slate-500 border-b-4')}
                    onClick={()=>{
                ...
                <button
                    ...
                    className={"px-4 py-2 border border-slate-500 text-slate-500 transition-all duration-200"+
                        (!started && lifetime==0?' translate-y-[4px]':' hover:text-white hover:bg-slate-500 border-b-4')}
                    onClick={()=>{
            ...
            <div className="flex-1">
                <div style={{display:"block", fontFamily:'ReceiptionalReceipt'}} className="m-1 ml-3">
                    <div className="bg-slate-900 p-1 border-slate-500 border" style={{width: "fit-content", minWidth:"161.88px"}}>
